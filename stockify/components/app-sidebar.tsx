...
navMain: [
  ...
  },
  {
    ...
    url: "/agent-discussion",
    icon: (
      <MessageCircleIcon />
    ),
  },
  {
    title: "Formulas and template analysis",
    url: "/formulas-template-analysis",
    icon: (
      <CalculatorIcon />
    ),
  },
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              ...
              <span className="text-base font-semibold"> Stockify</span>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarHeader>
